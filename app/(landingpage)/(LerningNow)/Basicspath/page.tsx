...
import { Lightbulb, Code, GitBranch, Puzzle, Trophy, Check } from "lucide-react";

const cardStyles = [
  { accent: "border-l-yellow-500", glow: "hover:shadow-yellow-500/10", iconBg: "bg-yellow-500/10 text-yellow-400", badgeClass: "bg-yellow-500/10 text-yellow-400 border-yellow-500/30", Icon: Lightbulb },
  { accent: "border-l-blue-500",   glow: "hover:shadow-blue-500/10",   iconBg: "bg-blue-500/10 text-blue-400",   badgeClass: "bg-blue-500/10 text-blue-400 border-blue-500/30",   Icon: Code      },
  { accent: "border-l-green-500",  glow: "hover:shadow-green-500/10",  iconBg: "bg-green-500/10 text-green-400", badgeClass: "bg-green-500/10 text-green-400 border-green-500/30", Icon: GitBranch },
  { accent: "border-l-pink-500",   glow: "hover:shadow-pink-500/10",   iconBg: "bg-pink-500/10 text-pink-400",   badgeClass: "bg-pink-500/10 text-pink-400 border-pink-500/30",   Icon: Puzzle    },
  { accent: "border-l-emerald-500",glow: "hover:shadow-emerald-500/10",iconBg: "bg-emerald-500/10 text-emerald-400",badgeClass: "bg-emerald-500/10 text-emerald-400 border-emerald-500/30",Icon: Trophy },
];

export default function Basicspath() {
  const t = useTranslations("BasicsPathPage");
        ...
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="text-center mb-16">
          ...
          <div className="inline-flex items-center gap-8 bg-card border border-border rounded-2xl px-8 py-4">
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-muted-foreground mt-0.5">{t("statXp")}</p>
            </div>
            <div className="text-center">
