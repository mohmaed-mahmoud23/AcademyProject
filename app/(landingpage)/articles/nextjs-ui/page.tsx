  ...
  return (
    <article className="min-h-screen bg-background text-foreground px-6 py-20">
      <div className="max-w-3xl mx-auto">
        ...
        {/* Header */}
        <div className="mb-10">
          <span className="text-xs font-semibold px-3 py-1 rounded-full border bg-white/10 text-white border-white/20 mb-4 inline-block">
            Next.js
          </span>
          ...
          <div className="flex items-center gap-4 text-sm text-muted-foreground">
            <span className="flex items-center gap-1.5">
              <Calendar size={13} /> مارس 2026
            </span>
            <span className="flex items-center gap-1.5">
              <Clock size={13} /> 6 دقائق قراءة
            </span>
        ...
        <div className="prose prose-invert max-w-none space-y-8 text-base leading-relaxed text-foreground/90">
          <p>
            Next.js أصبح الخيار الأول لبناء تطبيقات الويب الحديثة، وليس فقط لأنه
            سريع — بل لأنه يمنحك بنية واضحة تجعل مشاريعك قابلة للنمو والتوسع. في
            هذا المقال سنتحدث عن كيفية بناء نظام واجهة مستخدم (UI System)
            احترافي من الصفر باستخدام Next.js.
          </p>
          ...
          <p>
            أكثر مشكلة تواجه المطورين المبتدئين هي أنهم يضعون كل شيء في مكان
            واحد. البنية الصحيحة تفصل بين المكونات القابلة لإعادة الاستخدام (
            <code className="bg-muted px-1.5 py-0.5 rounded text-sm">
              components/ui
            </code>
            ) والصفحات (
            <code className="bg-muted px-1.5 py-0.5 rounded text-sm">app/</code>
            ) والمنطق (
            <code className="bg-muted px-1.5 py-0.5 rounded text-sm">lib/</code>
            ).
          </p>
          ...
          <p>
            ميزة Route Groups في Next.js App Router تسمح لك بتجميع الصفحات
            المتشابهة دون أن يؤثر ذلك على الـ URL. مثلاً، صفحات الـ Dashboard
            تحتاج layout مختلف عن صفحات التسويق — باستخدام
            <code className="bg-muted px-1.5 py-0.5 rounded text-sm">
              (dashboard)
            </code>
            و
          ...
          <p>
            Tailwind رائع لكنه يصبح فوضوياً بدون نظام. الحل؟ استخدم{" "}
            <code className="bg-muted px-1.5 py-0.5 rounded text-sm">cn()</code>{" "}
            من مكتبة{" "}
            <code className="bg-muted px-1.5 py-0.5 rounded text-sm">clsx</code>{" "}
            لدمج الكلاسات، وأنشئ مكونات UI قابلة لإعادة الاستخدام بدلاً من كتابة
            نفس الكلاسات في كل مكان.
          </p>
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-2xl p-6 mt-8">
            ...
            <p className="text-muted-foreground text-sm">
              Next.js ليس مجرد framework — هو منهجية تفكير. ابدأ ببنية واضحة،
              افصل المسؤوليات، واستخدم Server Components كلما أمكن. مشروعك سيكون
