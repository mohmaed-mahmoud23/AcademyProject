...
export default function ReactStudyPlan() {
  const t = useTranslations("StudyPlan");
  const tr = useTranslations("StudyPlanReact");
  ...
  const reactStudyPlan = [
    {
      ...
      lessons: [
        ...
        { number: 2, title: tr("w1l2"), type: t("practical") },
      ...
      keywords: ["React", "JSX", "Components", "Props", "UI"],
    },
    {
      week: tr("week2"),
      lessons: [
      ...
      keywords: ["State", "Hooks", "Events", "Rendering", "Keys"],
    },
    {
      week: tr("week3"),
      lessons: [
        ...
        { number: 13, title: tr("w3l3"), type: t("practical") },
        { number: 14, title: tr("w3l4"), type: t("theory") },
        { number: 15, title: tr("w3l5"), type: t("practical") },
      ],
      assignments: [{ title: tr("w3a1"), count: 14 }],
      keywords: ["useEffect", "API", "Lifecycle", "Fetching", "Cleanup"],
    },
    {
      week: tr("week4"),
      lessons: [
        { number: 16, title: tr("w4l1"), type: t("theory") },
        { number: 17, title: tr("w4l2"), type: t("practical") },
        { number: 18, title: tr("w4l3"), type: t("theory") },
        { number: 19, title: tr("w4l4"), type: t("theory") },
        { number: 20, title: tr("w4l5"), type: t("practical") },
      ],
      assignments: [{ title: tr("w4a1"), count: 15 }],
      keywords: ["Forms", "Router", "Validation", "Pages", "Navigation"],
    },
    {
      week: tr("week5"),
      lessons: [
      ...
      assignments: [{ title: tr("w5a1"), count: 16 }],
      keywords: ["Context", "Global State", "Redux", "Zustand", "Store"],
    },
    {
      week: tr("week6"),
      lessons: [
        ...
        { number: 29, title: tr("w6l4"), type: t("theory") },
        { number: 30, title: tr("w6l5"), type: t("practical") },
      ],
      assignments: [{ title: tr("w6a1"), count: 20 }],
      keywords: ["Architecture", "Reusable", "Performance", "E-commerce", "Optimization"],
    },
  ];
  return (
